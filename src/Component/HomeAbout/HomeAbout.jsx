...
import img1 from '../../assets/homeAbout/DSC06842.jpg'
import img2 from '../../assets/homeAbout/DSC06888.jpg'
      ...
      <div className='grid grid-cols-1 md:grid-cols-2  gap-20'>
        ...
        >
          ...
          <div  style={{ boxShadow: '5px 5px 20px rgb(59 130 246)' }} className='p-10  border-l-4 border-blue-500
            ...
            <img className=' md:h-[700px] h-[500px] absolute top-[5%] left-[1%]   ml-[-1000px] rounded-[50%] group-hover:ml-0   w-full  hover:scale-105 duration-[2s]  border-l-[10px] border-blue-500  group-hover:border-blue-500/10    ' src={img2} alt=""
              style={{ boxShadow: '5px 5px 20px rgb(59 130 246)' }} />




            <img className=' md:h-[700px] h-[500px]  w-full  hover:scale-105 duration-[2s]  border-l-[10px] border-blue-500 rounded-[30px] group-hover:opacity-0 group-hover:border-blue-500/10    ' src={img1} alt=""
              style={{ boxShadow: '5px 5px 20px rgb(59 130 246)' }} />
