        ...
        <>
            ...
            >
                <div style={{ boxShadow: '5px 5px 15px rgb(59 130 246)' }} className="card w-full btn-outline hover:scale-110 duration-[1s] border-l-2 border-blue-500">
                    ...
                    <div className="card-body">
                        <h2 className="text-[20px] text-white font-[400] my-5 text-center">Booking College</h2>
            ...
            <dialog id="my_modal_1" className="modal ">
               ...
               ">
                        ...
                        <div className="card-body">
                            <h2 className="text-[25px] text-white font-[400] my-5 text-center">Booking College</h2>

                            <div className=' text-white text-[18px] font-[400]'>
                                <span className=''>This is a College booking website.It's a full Stack website.This project is completed with MERN.Many technologies are used in this project and it has many features, some examples are given below.</span>

                                <section className='my-10'>
                                    <h3 className=' font-[500] mb-1' >Features:</h3>
                                    <p>* Users can search colleges by name.</p>
                                    <p>* Users can select their desired colleges for admission.</p>
