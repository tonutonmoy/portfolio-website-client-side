...
const HomeBanner = () => {
  ...
  return (
    <div className='home-banner-container  bg-fixed  relative h-[670px] md:h-[886px] '  >
      ...
      <div className=' absolute top-[60%] w-[90%] left-[10%] md:w-[70%] md:top-[40%] md:left-[19%]'>
        <h2 className=' text-[40px] md:text-[60px] font-[700] text-white'>I'm Showmik Arifen Tonmoy </h2>
        <div className='text-[30px] md:text-[40px] font-[500]  
