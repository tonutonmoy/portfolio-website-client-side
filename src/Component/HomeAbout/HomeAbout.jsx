      ...
      <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2  gap-20'>
        ...
        >
          ...
          <div  style={{ boxShadow: '5px 5px 20px rgb(59 130 246)' }} className='p-10  border-l-4 border-blue-500
            ...
            <img className=' h-[500px] md:h-[600px] lg:h-[650px] xl:h-[700px] 2xl:h-[700px] absolute top-[5%] left-[1%]   ml-[-2000px] rounded-[50%] group-hover:ml-0   w-full  hover:scale-105 duration-[2s]  border-l-[10px] border-blue-500  group-hover:border-blue-500/10    ' src={img2} alt=""
              style={{ boxShadow: '5px 5px 20px rgb(59 130 246)' }} />




            <img className=' h-[500px] md:h-[600px] lg:h-[650px] xl:h-[700px] 2xl:h-[700px]  w-full  hover:scale-105 duration-[2s]  border-l-[10px] border-blue-500 rounded-[30px] group-hover:opacity-0 group-hover:border-blue-500/10    ' src={img1} alt=""
              style={{ boxShadow: '5px 5px 20px rgb(59 130 246)' }} />
